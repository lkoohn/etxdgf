...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "24cfe538-61ec-48a9-8499-40f2783ec670"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("REALITY_PORT", "25776");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
