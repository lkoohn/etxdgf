...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "947d55da-6811-4cce-94fa-e18c64082c88"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("REALITY_PORT", "25784");       // reality节点(tcp协议)端口，支持多端口可以填写，否则留空
